                                    ...
                                    <td align="center" style="padding: 0; margin: 0; vertical-align: middle;">
                                      <a href="${process.env.CLIENT_URL}" target="_blank" style="display: inline-block;">
                                        <img
                                          align="center"
                                          border="0"
                                          src="https://lh3.googleusercontent.com/a/ACg8ocLgwEZeWcyjSi2xhAz2IdGRhpTj8xETZsa_Vn6LnU25359sg0Y=s432-c-no"
                                          alt="ZensyncLogo"
                                          title="ZensyncLogo"
                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div style="font-size: 14px; color: #fafaff; line-height: 160%; text-align: center; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 22px; line-height: 35.2px;">Hi ${fullname}, </span></p>
                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div align="center">
                                  ...
                                  <a href=${process.env.SERVER_URL}/auth/verify-email?email=${email}&token=${token} target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #fdf8f8; background-color: #013f7e; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                  ...
                                  <p style="line-height: 160%;"><span style="color: #ffffff;"><span style="font-size: 18px; line-height: 28.8px;">BEDROCK </span></span>
                                  </p>
                                </div>
